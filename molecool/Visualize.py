...
from .data import atom_colors #We can import our atom colors by looking within the current directory. It will look in all folders and files for a module or fcn named atom_colors
